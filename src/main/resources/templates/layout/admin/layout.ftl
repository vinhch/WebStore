...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="/contents/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/contents/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <script src="/contents/metisMenu/metisMenu.min.js"></script>
